          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <ScrollReveal className="md:col-span-2">
              <div className="card-light p-8">
                ...
                <a
                  href="https://givebutter.com/Linksi-Launch-bcdvbm"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full mt-2 flex items-center justify-center gap-2 bg-brand-orange hover:bg-orange-600 text-white font-display font-bold px-8 py-4 rounded-xl transition-colors"
                >
                ...
                <p className="text-center text-xs text-slate-500 mt-2.5">Powered by GiveButter</p>
              </div>
            </ScrollReveal>
