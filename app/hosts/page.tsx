...
const hostBenefits = [
  {
    ...
    desc: "Monthly anonymized reports show which service categories residents searched for most, emerging needs, and where resource gaps exist — intelligence you can bring to board meetings and grant applications.",
    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />,
  },
  {
    title: "Become the Front Door to Help",
    desc: "People already trust you. Hosting Linksi lets them start their search for services right on your website or in your facility — without being redirected somewhere unfamiliar.",
    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />,
  },
  {
    title: "Reduce Misrouted Requests",
    desc: "Linksi helps residents find the right service before they call, email, or walk through your doors — so your staff spends less time triaging and redirecting.",
    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />,
  },
  {
    title: "Zero Data Management",
    desc: "You don't collect personal information, maintain databases, or manage the system. Linksi handles all of the technology. Your only job is welcoming visitors.",
    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />,
  },
  {
    title: "Extend Your Community Reach",
    desc: "Connect people to services across the entire county — even services you don't directly provide. Your impact grows without adding workload.",
    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />,
  },
  {
    title: "Recognition as a Community Connector",
    desc: "Hosts are listed in the Impact Works directory and featured monthly in the rotating 'Find Help Now' spotlight — publicly recognized as a trusted access point for your region.",
...
const hostTools = [
  {
    name: "Usage Reports",
    desc: "Monthly summary of searches and referrals originating from your site or QR code.",
  ...
  {
    name: "Community Need Trends",
    desc: "See which service categories are most searched in your area over time.",
    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />,
  },
  {
    name: "Resource Gap View",
    desc: "Identify where resident demand exceeds available provider capacity.",
    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />,
  },
  {
    name: "Embed & QR Generator",
    desc: "Get your unique website embed code or printable QR code from your dashboard.",
...
export default function Hosts() {
  return (
    <div>
      ...
      {/* What You Get as a Host — benefits & tools */}
      <section className="section-pad bg-white border-b border-slate-100">
        <div className="max-w-site mx-auto">
          <ScrollReveal className="mb-10">
            <p className="eyebrow mb-3">Host Benefits</p>
            <h2 className="heading-section text-slate-800">
              What You Get as a <span className="gradient-text-blue">Linksi Host</span>
            </h2>
            <p className="body-text-muted mt-3 max-w-2xl">
              Hosting Linksi gives your organization more than a referral tool — it gives you community intelligence, reduced staff burden, and a recognized role at the center of local impact.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="bg-brand-blue/5 border border-brand-blue/15 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-9 h-9 rounded-lg bg-brand-blue/15 border border-brand-blue/20 flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4 text-brand-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <div>
                  <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-brand-blue font-semibold">Your Host Dashboard</p>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {hostTools.map((tool) => (
                  <div key={tool.name} className="flex items-start gap-3 bg-white rounded-xl p-4 border border-brand-blue/10 shadow-sm">
                    <div className="w-7 h-7 rounded-md bg-brand-blue/10 flex items-center justify-center flex-shrink-0 mt-0.5">
